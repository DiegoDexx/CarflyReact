...
export const RestPage = () => {
  return (
      ...
      <div className="content-container">
        <div className="row">
         ...
         <div className="col-md-6">
                  <img className="img1" src="https://i.ibb.co/QD6xzdG/car-rented.png"></img>
        </div>
        ...
        <div className="row">
          ...
          <div className="col-md-6 container-img">
            <div className="photo img3">
              <img src="https://i.ibb.co/w4kD3Yc/taxi-app-concept.png" alt="Image 3" height="300px" width="400px" />
            </div>
          </div>
        </div>
      </div>
    ...
    <img src="https://i.ibb.co/S70wM0q/happy-delivery-guy-holding-box.jpg"  alt="Delivery Guy" class="hero-banner-image" />
